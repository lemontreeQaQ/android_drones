...
//                                Toast.makeText(getContext(),"111",Toast.LENGTH_SHORT).show();
    ...
    /**
     * mock数据，提前把桥梁数据插入到db中
     */

    private void mockDate(){

        String[] mock = {"鱼洞长江大桥","嘉陵江大桥","朝阳桥","马桑溪长江大桥","渝澳大桥","蔡家嘉陵江轨道专用桥","李家沱长江大桥","嘉华大桥","北碚嘉陵江大桥","鹅公岩大桥","石门大桥","朝天门大桥","鹅公岩轨道桥","高家花园大桥","大佛寺长江大桥","菜园坝长江大桥","高家花园复线桥","寸滩长江大桥","重庆长江大桥","高家花园轨道大桥","马鞍石大桥","东水门长江大桥","双碑大桥","广阳岛大桥","千厮门大桥","鱼嘴两江大桥","黄花园大桥","嘉悦大桥","水土嘉陵江大桥"};

        for (int i = mock.length-1; i >= 0; i--) {
            boolean hasData = hasData(mock[i]);
            if(!hasData){
                insertData(mock[i]);
            }
